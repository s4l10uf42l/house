...
<body>
    ...
    <div class="container mt-5"> -->
                ...
                <p>Article 18&nbsp;: Le propri&eacute;taire autorise &agrave; <strong> {{$unlocataire->sexe}}   {{$unlocataire->prenom}}  {{$unlocataire->nom}} </strong> de faire un abonnement en son nom pour le branchement particulier &agrave; l&rsquo;eau et &agrave; l&rsquo;&eacute;lectricit&eacute; au niveau de la SEN EAU et de la SENELEC.</p>
    ...
    <div class="d-flex justify-content-end mb-4">
            <a class="btn btn-primary" href="{{route('house.contract',$unlocataire) }}" >Exporter en PDF</a>
     </div>
